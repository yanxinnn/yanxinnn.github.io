...
export const pypelineDescriptions = [
  "Pypeline is a SaaS application designed to empower data professionals, enabling them to optimize data processes, automate tasks, and drive efficiency in data acquisition and processing. This project aims to enhance the user experience in managing, cleaning, and transforming data through an intuitive, no-code platform.<br><br>As the UX Developer on the Pypeline team, I led as the sole designer and oversaw all aspect of the end-to-end UX design process, from inception to public launch. I collaborated with a diverse global team of over 15 professionals, including product managers, front-end developers, data scientists, and DevOps engineers, to ensure the seamless delivery of a user-centric and visually compelling product.<br><br>\
...
export const wizardsJourneyDescriptions = [
  ...
  <div class='funFact'>✿ Fun fact: This video showcasing the gameplay took multiple takes because my sister/opponent was not the best gamer and unfortunately kept dying before we could reach the top.",
